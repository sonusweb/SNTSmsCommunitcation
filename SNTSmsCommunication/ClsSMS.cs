    ...
    public class ClsSMS
    {
        ...
        public ShortMessageCollection ReadSMS(SerialPort port, string p_strCommand)
        {
            ...
            try
            {
                ...
                // Use character set"PCCP" instead of  "PCCP437", this modem deosn't support
                ExecCommand(port, "AT+CSCS=\"PCCP\"", 300, "Failed to set character set.");
                // Select SIM storage
